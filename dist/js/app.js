...
(function(exports) {
  ...
  var runMatch = function (v) {
      return function (route) {
          ...
          return Data_Validation_Semiring.unV(foldErrors)(function ($92) {
              return Data_Either.Right.create(Data_Tuple.snd($92));
          })(v(route));
      };
  };        
...
(function(exports) {
  ...
  var routing = (function () {
      var tag = Data_Functor.map(Routing_Match.matchFunctor)(Tag.create)(Control_Apply.applySecond(Routing_Match.matchApply)(Routing_Match_Class.lit(Routing_Match.matchMatchClass)("tags"))(Routing_Match_Class.str(Routing_Match.matchMatchClass)));
      ...
      var articles = Data_Functor.voidRight(Routing_Match.matchFunctor)(Articles.value)(Routing_Match_Class.lit(Routing_Match.matchMatchClass)("articles"));
      var article = Data_Functor.map(Routing_Match.matchFunctor)(Article.create)(Control_Apply.applySecond(Routing_Match.matchApply)(Routing_Match_Class.lit(Routing_Match.matchMatchClass)("articles"))(Routing_Match_Class.str(Routing_Match.matchMatchClass)));
      var about = Data_Functor.voidRight(Routing_Match.matchFunctor)(About.value)(Routing_Match_Class.lit(Routing_Match.matchMatchClass)("about"));
      return Control_Alt.alt(Routing_Match.matchAlt)(Control_Alt.alt(Routing_Match.matchAlt)(Control_Alt.alt(Routing_Match.matchAlt)(Control_Alt.alt(Routing_Match.matchAlt)(about)(article))(articles))(tag))(home);
  })();
  exports["Home"] = Home;
  exports["About"] = About;
...
(function(exports) {
  ...
  var parseQueryPart = function (decoder) {
      var part2tuple = function (input) {
          var keyVal = Data_Functor.map(Data_Functor.functorArray)(decoder)(Data_String.split("=")(input));
      ...
      return function ($11) {
          return Data_Functor.map(Data_Maybe.functorMaybe)(Data_Map.fromFoldable(Data_Ord.ordString)(Data_Foldable.foldableArray))(Data_Traversable.traverse(Data_Traversable.traversableArray)(Data_Maybe.applicativeMaybe)(part2tuple)(Data_String.split("&")($11)));
      };
  };
  var parse = function (decoder) {
      return function (hash) {
          ...
          var v = Control_Bind.bindFlipped(Data_Maybe.bindMaybe)(Data_Function.flip(Data_String.splitAt)(hash))(Data_String.indexOf("?")(hash));
          if (v instanceof Data_Maybe.Just) {
              return Data_Semigroup.append(Data_List_Types.semigroupList)(pathParts(v.value0.before))(Data_Functor.map(Data_List_Types.functorList)(Routing_Types.Query.create)(Data_List.fromFoldable(Data_Foldable.foldableMaybe)(parseQueryPart(decoder)(Data_String.drop(1)(v.value0.after)))));
          };
          if (v instanceof Data_Maybe.Nothing) {
...
})(PS["Themes.Default.Article"] = PS["Themes.Default.Article"] || {});
(function(exports) {
    "use strict";
  var Control_Applicative = PS["Control.Applicative"];
  var Data_Eq = PS["Data.Eq"];
  ...
  exports["eqSlot"] = eqSlot;
  exports["ordSlot"] = ordSlot;
})(PS["Themes.Default.Articles"] = PS["Themes.Default.Articles"] || {});
(function(exports) {
    "use strict";
  var Control_Applicative = PS["Control.Applicative"];
  var Data_Eq = PS["Data.Eq"];
  ...
  exports["eqSlot"] = eqSlot;
  exports["ordSlot"] = ordSlot;
})(PS["Themes.Default.Page"] = PS["Themes.Default.Page"] || {});
(function(exports) {
    "use strict";
  var Control_Applicative = PS["Control.Applicative"];
  var Data_Either = PS["Data.Either"];
  ...
  var Prelude = PS["Prelude"];
  var Routers = PS["Routers"];
  var Themes_Default_Article = PS["Themes.Default.Article"];
  var Themes_Default_Articles = PS["Themes.Default.Articles"];
  var Themes_Default_Page = PS["Themes.Default.Page"];        
  var Slot = (function () {
      function Slot() {
  ...
  var initialState = Routers.Articles.value;
  var eqSlot = new Data_Eq.Eq(function (x) {
      return function (y) {
          return true;
      };
  ...
  var component = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.section([ Halogen_HTML_Properties.class_("columns") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "column", "is-half", "is-offset-one-quarter", "articles" ])) ])([ Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp1)(Themes_Default_Articles.Slot.value)(Themes_Default_Articles.component)(state)(Data_Void.absurd) ]) ]);
      };
      var $$eval = function (v) {
          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
      };
      return Halogen_Component.parentComponent(Data_Either.ordEither(Themes_Default_Articles.ordSlot)(Data_Either.ordEither(Themes_Default_Article.ordSlot)(Data_Either.ordEither(Themes_Default_Page.ordSlot)(Data_Ord.ordVoid))))({
  ...
  exports["eqSlot"] = eqSlot;
  exports["ordSlot"] = ordSlot;
})(PS["Themes.Default.Body"] = PS["Themes.Default.Body"] || {});
(function(exports) {
  // Generated by purs version 0.11.7
  "use strict";
  var Control_Applicative = PS["Control.Applicative"];
  ...
  var component = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.footer([ Halogen_HTML_Properties.class_("footer") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("container") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "content", "has-text-centered" ])) ])([ Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("The website content is licensed "), Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("http://creativecommons.org/licenses/by-nc-sa/4.0/") ])([ Halogen_HTML_Core.text("CC BY NC SA 4.0") ]) ]) ]) ]) ]);
      };
      var $$eval = function (v) {
          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
      };
  ...
  exports["eqSlot"] = eqSlot;
  exports["ordSlot"] = ordSlot;
})(PS["Themes.Default.Footer"] = PS["Themes.Default.Footer"] || {});
(function(exports) {
    "use strict";
  var Control_Applicative = PS["Control.Applicative"];
  var Data_Eq = PS["Data.Eq"];
  ...
  var component = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.nav([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "navbar", "is-fixed-top", "is-transparent" ])) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("navbar-brand") ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.class_("navbar-item") ])([ Halogen_HTML_Elements.img([ Halogen_HTML_Properties.src("images/logo.png"), Halogen_HTML_Properties.alt("Haskell Cafe"), Halogen_HTML_Properties.width(28) ]) ]), Halogen_HTML_Elements.button([ Halogen_HTML_Properties.classes(Data_Functor.map(Data_Functor.functorArray)(Halogen_HTML_Core.ClassName)([ "button", "navbar-burger" ])), Halogen_HTML_Properties.attr("data-target")("navMenu") ])([ Halogen_HTML_Elements.span_([  ]), Halogen_HTML_Elements.span_([  ]) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("navbar-menu"), Halogen_HTML_Properties.id_("navMenu") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("navbar-start") ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.class_("navbar-item"), Halogen_HTML_Properties.href("#/") ])([ Halogen_HTML_Core.text("Home") ]), Halogen_HTML_Elements.a([ Halogen_HTML_Properties.class_("navbar-item"), Halogen_HTML_Properties.href("#/about") ])([ Halogen_HTML_Core.text("About") ]) ]) ]) ]);
      };
      var $$eval = function (v) {
          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
      };
  ...
  exports["eqSlot"] = eqSlot;
  exports["ordSlot"] = ordSlot;
})(PS["Themes.Default.Header"] = PS["Themes.Default.Header"] || {});
(function(exports) {
  // Generated by purs version 0.11.7
  "use strict";
  var Control_Applicative = PS["Control.Applicative"];
  ...
  var Themes_Default_Body = PS["Themes.Default.Body"];
  var Themes_Default_Footer = PS["Themes.Default.Footer"];
  var Themes_Default_Header = PS["Themes.Default.Header"];        
  var GOTO = (function () {
  ...
  var matchRoutes = function (app) {
      var redirects = function (driver) {
          return function (v) {
              return function ($5) {
                  return Control_Monad_Aff.launchAff_(driver.query(Halogen_Query.action(GOTO.create($5))));
              };
          };
      };
      return Routing.matches(Routers.routing)(redirects(app));
  };
  var initialState = Routers.Home.value;
  var component = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp1)(Themes_Default_Header.Slot.value)(Themes_Default_Header.component)(Data_Unit.unit)(Data_Void.absurd), Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp2)(Themes_Default_Body.Slot.value)(Themes_Default_Body.component)(state)(Data_Void.absurd), Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp3)(Themes_Default_Footer.Slot.value)(Themes_Default_Footer.component)(Data_Unit.unit)(Data_Void.absurd) ]);
      };
      var $$eval = function (v) {
      ...
      return Halogen_Component.parentComponent(Data_Either.ordEither(Themes_Default_Header.ordSlot)(Data_Either.ordEither(Themes_Default_Body.ordSlot)(Data_Either.ordEither(Themes_Default_Footer.ordSlot)(Data_Ord.ordVoid))))({
          initialState: Data_Function["const"](initialState),
          render: render,
          "eval": $$eval,
          receiver: Data_Function["const"](Data_Maybe.Nothing.value)
...
})(PS["Themes.Default.Layout"] = PS["Themes.Default.Layout"] || {});
(function(exports) {
  // Generated by purs version 0.11.7
  "use strict";
  var Control_Bind = PS["Control.Bind"];
  ...
  var Prelude = PS["Prelude"];
  var Themes_Default_Layout = PS["Themes.Default.Layout"];        
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_VDom_Driver.runUI(Themes_Default_Layout.component)(Data_Unit.unit)(v))(function (v1) {
          return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Themes_Default_Layout.matchRoutes(v1));
      });
  }));
  exports["main"] = main;
})(PS["Main"] = PS["Main"] || {});
